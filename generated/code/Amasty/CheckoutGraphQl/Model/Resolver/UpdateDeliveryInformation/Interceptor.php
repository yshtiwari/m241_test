...
class Interceptor extends \Amasty\CheckoutGraphQl\Model\Resolver\UpdateDeliveryInformation implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Amasty\CheckoutGraphQl\Model\Utils\CartProvider $cartProvider, \Magento\Framework\Module\Manager $moduleManager)
    {
        $this->___init();
        parent::__construct($cartProvider, $moduleManager);
    }
