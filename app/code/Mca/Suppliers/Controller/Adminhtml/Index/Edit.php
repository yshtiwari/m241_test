...
class Edit extends \Magento\Backend\App\Action
{
	...
	public function execute()
    {
        ...
        $this->_coreRegistry->register('mca_supplier', $model);
        $this->_initAction();
        $this->_view->getLayout()->getBlock('suppliers_suppliers_edit');
		$this->_view->getPage()->getConfig()->getTitle()->set(__('Suppliers'));
