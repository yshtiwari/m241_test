...
{
    public const XML_PATH_LIST_MODE = 'codazon_lookbook/listing/lookbook_item_list/list_mode';
    public const DEFAULT_SORT_DIRECTION = 'asc';
    const VIEW_MODE_LIST = 'list';
    const VIEW_MODE_GRID = 'grid';
    const XML_PATH_LIST_DEFAULT_SORT_BY = 'codazon_lookbook/listing/lookbook_item_list/default_sort_by';
    ...
    public function getAvailableLimit($viewMode): array
    {
        ...
        $perPageConfigPath = 'codazon_lookbook/listing/lookbook_item_list/' . $viewMode . '_per_page_values';
        $perPageValues = (string)$this->scopeConfig->getValue($perPageConfigPath, ScopeInterface::SCOPE_STORE);
        $perPageValues = explode(',', $perPageValues);
        $perPageValues = array_combine($perPageValues, $perPageValues);
        if ($this->scopeConfig->isSetFlag('codazon_lookbook/listing/lookbook_item_list/list_allow_all', ScopeInterface::SCOPE_STORE)) {
    ...
    {
        $xmlConfigPath = sprintf('codazon_lookbook/listing/lookbook_item_list/%s_per_page', $viewMode);
