...
namespace Codazon\Shopbybrandpro\Model\Brand\BrandList;
...
class ToolbarMemorizer
{
     ...
     */
    const XML_PATH_CATALOG_REMEMBER_PAGINATION = 'codazon_shopbybrand/all_brand_page/remember_pagination';
