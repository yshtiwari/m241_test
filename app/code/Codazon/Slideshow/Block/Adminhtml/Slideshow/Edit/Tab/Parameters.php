...
{   
    ...
    {        
        ...
        $fieldset->addField(
            ...
            'select',
            [
                'name' => 'parameters[is_resize]', 
                'label' => __('Resize image'), 
                'title' => __('Resize image'),
                'options' => ['1' => __('Yes'), '0' => __('No')],              
                'note'  => __('Do you want to keep uploaded original image. This is image may have difference quality because it was modified by magento upload function.')
            ]
        );
