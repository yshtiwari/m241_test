define([
    ...
    'Dotsquares_Opc/js/action/gift-message',
    'dotsquaresOpcHelper'
    ...
    return Component.extend({
        defaults: {
            template: 'dotsquares_Opc/standart/gift-message'
        },
        ...
        bindGiftMessageFields: function () {
            var self = this;
            $(document).on('input change', '#dotsquares_opc_gift_message form input, #dotsquares_opc_gift_message form select, #dotsquares_opc_gift_message form textarea', function (e) {
                self.saveGiftMessage($(this).closest('form').attr('data-dotsquares-gm-id'));
            });
        },
        ...
        prepareData: function (itemId, save) {
            var form = $('#dotsquares_opc_gift_message form[data-dotsquares-gm-id=' + itemId + ']');
