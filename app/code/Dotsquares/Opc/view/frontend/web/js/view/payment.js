define(
    [
        ...
        'uiRegistry',
        'Dotsquares_Opc/js/model/payment/is-loading',
    ...
    function ($,
        ...
        $.validator.addMethod('validate-dotsquares-opc-cc-exp', function (value, element) {
            var isValid = false;
        ...
        return Component.extend({
            defaults: {
                template: 'Dotsquares_Opc/payment',
                activeMethod: ''
            },
            ...
            initialize: function () {
                ...
                $(document).on('mouseover', '.dotsquares_opc_cc_types_tooltip', function () {
                    var fixedContent = $(this).find('.dotsquares_opc_field_tooltip_content');
                ...
                $(document).on('input', '.dotsquares_opc_cc_wrapper .dotsquares_opc_cc_input', function (e) {
                    self.formatCcNumber($(this), e);
                    var v = $(this).val().replace(/\s+/g, '').replace(/[^0-9]/gi, '');
                    self.fillCcNumberField($(this), v);
                });

                $(document).on('keydown', '.dotsquares_opc_cc_exp, .dotsquares_opc_cc_wrapper .dotsquares_opc_cc_input', function (e) {
                    self.checkNumberInput($(this), e);
                });

                $(document).on('input', '.dotsquares_opc_cc_exp', function (e) {
                    var value = $(this).val();
            ...
            fillCcNumberField: function (element, value) {
                var ccNumberField = element.closest('.field').find('input.dotsquares_opc_cc_real_input');
