...
define( defineArray,
    function (
        ...
        return Component.extend({
            defaults: {
                template: 'Dotsquares_Opc/shipping'
            },
            canHideErrors: true,
            ...
            displayAllMethods: window.checkoutConfig.dotsquaresOpcSettings.displayAllMethods,
            specificMethodsForDisplayAllMethods: ['dotsquaresstorepickup'],
            ...
            initialize: function () {
                ...
                this.shippingRateGroup.subscribe(function (carrierTitle) {
                    ...
                    var $selectize = $('#dotsquares_opc_shipping_method_rates');
