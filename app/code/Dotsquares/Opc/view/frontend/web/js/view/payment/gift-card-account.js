define(
    [
        ...
        'ko',
        'uiComponent',
        'Dotsquares_Opc/js/action/set-gift-card-information',
    ...
    function ($,
        ...
        return Component.extend({
            defaults: {
                template: 'Dotsquares_Opc/payment/gift-card-account',
            ...
            cancel: function () {
                $('#dotsquares_opc_gift_card [data-role=trigger]').trigger('click');
            },
            validate: function () {
