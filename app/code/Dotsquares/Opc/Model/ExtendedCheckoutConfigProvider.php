...
class ExtendedCheckoutConfigProvider implements ConfigProviderInterface
{
    ...
    {
        $config = [];
        $config['dotsquaresOpcSettings'] = $this->getSettings();
    ...
    public function getSettings()
    {
        ...
        $settings['paymentLogosImages'] = [
            'paypal' => $this->getViewUrl('Dotsquares_Opc::images/paypal_logo.png'),
            'apple_pay' => $this->getViewUrl('Dotsquares_Opc::images/apple_pay_logo.png'),
        ];
