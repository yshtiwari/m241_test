    ...
    public function execute()
    {
        try {
            ...
            foreach ($this->processors->getExportProcessors() as $name => $processor) {
                ...
                $this->createCsv(DirectoryList::PUB.'/'.$file, $processor->export($customer));
                $this->zip->pack(DirectoryList::PUB.'/'.$file, DirectoryList::PUB.'/'.$zipFileName);
                $this->deleteCsv(DirectoryList::PUB.'/'.$file);
            }
