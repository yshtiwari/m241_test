...
return [
    'modules' => [
        ...
        'Codazon_Utility' => 1,
        'Dotsquares_Mathcaptcha' => 0,
        'Dotsquares_Opc' => 0,
        'Dotsquares_OrderComment' => 0,
        'Dotsquares_Rewardpoints' => 0,
        'Dotsquares_Shipping' => 0,
        'Ewave_ExtendedBundleProduct' => 0,
        ...
        'Qubabanner_Customcategorybanner' => 1,
